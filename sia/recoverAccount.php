...
$sql = "SELECT * FROM tblstaff WHERE deleted = true";
    ...
    <div class="view">
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                        <form class="users-form" action="./recoverUsersQuery.php" method="POST">
                            <tr>
                               <td><?= $row["id"] ?><input type="hidden" name="id" value="<?= $row["id"] ?>"></td>
                                ...
                                <td><button  type="submit" class='users-delete'>Recover</button></td>
                            </tr>
                        </form>
                <?php
                    }
